...
![Arquitectura MVC de una aplicación GUI](assets/img/01_arquitectura_gui.png)

*Figura: Arquitectura MVC de una aplicación GUI*
...
![Ciclo de manejo de eventos](assets/img/02_ciclo_eventos.png)

*Figura: Ciclo de manejo de eventos*
...
![Componentes típicos de una GUI](assets/img/03_componentes_gui.png)

*Figura: Componentes típicos de una GUI*
