...
![Tipos de relaciones entre tablas](assets/img/01_tipos_relaciones.png)
...
![Relación N:M con tabla intermedia](assets/img/02_tabla_intermedia.png)
...
![Pasos para crear una relación en Access](assets/img/03_crear_relacion.png)
...
![¿Qué es una consulta?](assets/img/04_que_es_consulta.png)
...
![Cómo elegir el tipo de consulta](assets/img/05_tipo_consulta.png)
